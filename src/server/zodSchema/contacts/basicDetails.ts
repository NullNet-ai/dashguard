...
export const ProfessionalDetailsForm = z.object({
  current_title: z.string().nullable().default("").optional(),
  current_company: z.string().nullable().default("").optional(),
  current_salary: z.number().nullable().optional(), //TODO: should be a number
  salary_currency: z.string().nullable().default("USD").optional(),
  notice_period: z.string().nullable().default("").optional(),
  years_of_experience: z.number().nullable().optional(), //TODO: should be a number
});

export const EducationDetailsForm = z.object({
  institution: z.string().nullable().default("").optional(),
  country_id: z.string().nullable().default("").optional(),
  degree: z.string().nullable().default("").optional(),
  degree_level_id: z.string().nullable().default("").optional(),
  completed_on: z.string().nullable().default("").optional(),
