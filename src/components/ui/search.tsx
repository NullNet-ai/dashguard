  ...
  (
          ...
          if (e.key === "Delete" || e.key === "Backspace") {
            if (input.value === "" && selected.length > 0) {
              ...
              if (!lastSelectOption?.fixed) {
                handleUnselect(selected.pop() as Option);
              }
            }
          }
    ...
    return (
      ...
      >
        <div
          className={cn(
            "min-h-10 rounded-md border border-input text-sm ring-offset-background focus-within:border focus-within:border-sky-600 focus-within:ring-offset-2",
            {
          ...
          <div className="flex w-full flex-row">
            ...
            <div className="relative flex w-full flex-wrap gap-1">
              ...
              <CommandPrimitive.Input
                ...
                className={cn(
                  "flex-1 bg-transparent pr-4 outline-none placeholder:text-muted-foreground",
                  {
