      ...
      <>
        ...
        <div className={cn("relative w-full",containerClassName)}>
          ...
          <input
            ...
            className={cn(
              "flex h-10 w-full read-only:cursor-text rounded-md border border-input bg-background px-3 py-1 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-0 disabled:pointer-events-none disabled:cursor-not-allowed  sm:text-md/6 disabled:bg-slate-100  disabled:text-gray-400 disabled:border-gray-300",
