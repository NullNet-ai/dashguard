    ...
    return (
      <>
        ...
        <div className={cn("relative w-full",containerClassName)}>
          {leftAddon && (
            <div
              className={cn(`pointer-events-none absolute left-1.5 top-1/2 -translate-y-1/2 transform`, iconClassName)}
            >
          ...
          <input
            ...
            className={cn(
              "flex text-slate-700 w-full read-only:cursor-text h-[36px] rounded-md border border-slate-200 bg-background px-[8px] py-1 md:text-md ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-0 disabled:pointer-events-none disabled:cursor-not-allowed focus-visible:border-primary  sm:text-md/6 disabled:bg-secondary text-lg  disabled:text-gray-400 disabled:border-gray-300",
