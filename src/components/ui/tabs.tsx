    ...
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        // Remove the default gap-2 and let it be controlled by the className
        {
          ...
          'box-border border-r-2 border-transparent text-gray-500 hover:text-gray-700 data-[state=active]:text-blue-600 data-[state=active]:after:absolute data-[state=active]:after:left-0 data-[state=active]:after:top-0 data-[state=active]:after:h-full data-[state=active]:border-primary data-[state=active]:after:w-0.5':
