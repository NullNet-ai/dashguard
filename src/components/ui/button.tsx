...
const buttonVariants = cva(
  "active:translate-y-1 transition duration-200 inline-flex items-center justify-center whitespace-nowrap text-xs font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        softPrimary: "bg-primary/10 hover:bg-primary/20 text-primary",
        softDestructive: "bg-destructive/10 hover:bg-destructive/20 text-destructive",
        softAccent: "bg-accent/10 hover:bg-accent/20 text-accent",
        softSecondary: "bg-secondary/10 hover:bg-secondary/20 text-secondary",
        secondary: "bg-secondary text-secondary-foreground hover:bg-slate-50 border border-[#E2E8F0]",
