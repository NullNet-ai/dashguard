        ...
        return (
          <SidebarContext.Provider value={contextValue}>
            <TooltipProvider delayDuration={0}>
              <div
                className={cn(
                  'group/sidebar-wrapper flex min-h-svh w-full overflow-hidden text-sidebar-foreground has-[[data-variant=inset]]:bg-sidebar', className,
                )}
                ref={ref}
                style={
                  {
...
>(
  (
    ...
    const { state, openMobile, setOpenMobile, setOpen } = useSidebar()
    ...
    if (screenType === 'sm' || screenType === 'xs') {
      ...
      return (
        ...
        >
          ...
          <div
            className={cn(
              'fixed inset-y-0 z-[100] hidden h-svh w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex', side === 'left'
