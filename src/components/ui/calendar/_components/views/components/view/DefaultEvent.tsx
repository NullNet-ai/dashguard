...
import { type GroupedEvent } from '~/components/ui/calendar/_components/views/_common/types';
...
const DefaultEvent = ({ event, hourIndex, eventIndex = 0, totalEventsInHour = 1, calenderType, onEventClick, timezone, allEventsInTimeline = [] }: Props) => {
  ...
  return (
    <div 
      key={event.id} 
      className={cn(
        "pl-6 last:mb-0 relative cursor-pointer",
    ...
    >
      ...
      <div className={cn(` bg-orange-50 p-4 rounded-md `,
