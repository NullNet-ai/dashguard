...
export function useTabPersistence({ code, prefix = 'tab-path', onPathChange }: UseTabPersistenceOptions) {
  ...
  }, [pathname, searchParams, isFirstRender, code, prefix, onPathChange])
