...
const GridtabDropItem = ({
  ...
  return (
    <>
      <Link
        data-test-id={'apptab-' + tabNameRole}
        onClick={(e) => {
          e?.preventDefault();
          e?.stopPropagation;
        ...
        className={cn(
          ...
          'whitespace-nowrap px-1 pr-1 text-sm font-medium',
      ...
      <div className="absolute right-0 hidden h-[50%] w-[1px] bg-gray-300 dark:bg-gray-600" />
      <GridMenuDropClient
        actions={actions}
        tab={tab}
        filter_id={tab?.id}
