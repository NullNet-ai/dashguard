              ...
              <Combobox>
                <div className="relative flex gap-2">
                  ...
                  <ComboboxInput
                    ...
                    autoComplete="off"
                    className="relative h-10 w-full flex-grow rounded-md border border-border bg-transparent pl-11 pr-4 text-foreground placeholder:text-muted-foreground focus:border focus:border-primary focus:ring-primary text-md disabled:bg-secondary  disabled:text-gray-400 disabled:border-gray-300"
                    placeholder="Search..."
                    onFocus={open}
                    onChange={(event) => {
