...
const Layout = async ({ children }: { children: React.ReactNode }) => {
  ...
  const organization_details = await api.record.getById({
  ...
  const { requirement_type, status } = organization_details?.data || {};
  ...
  return (
    ...
    >
      ...
      <RecordSummaryViewContent>
        <RecordShellSummary requirement_type={requirement_type} />
      </RecordSummaryViewContent>
    </PlatformRecord>
  );
};
