...
const RecordShellSummary = ({
  ...
  return (
    <Card>
      <div className='flex flex-col gap-y-2 p-3' data-test-id={testIDFormatter('rcrd-sum-details-container')}>
          <div className="px-2">
          ...
          return (
            ...
            >
              <div className="flex justify-between gap-2 px-2 text-sm">
                  ...
                  <span className="break-all" data-test-id={testIDFormatter(`rcrd-sum-details-${value}-value`)}>
                    {fieldValue || 'None'}
                  </span>
              </div>
            </div>
        ...
        {account && account.account_id && (
          ...
          >
            ...
            <div className="flex justify-between gap-2 px-2 text-sm">
              ...
              <span className='break-all' data-test-id={testIDFormatter('rcrd-sum-details-account-role-value')}>
                {account?.role || 'None'}
              </span>
            </div>
            <div className="flex justify-between gap-2 px-2 text-sm">
              ...
              <span className='break-all' data-test-id={testIDFormatter('rcrd-sum-details-account-email-value')}>
