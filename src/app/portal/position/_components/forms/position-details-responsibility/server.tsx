...
import PositionDetailsResponsibilitiesForm from "./client";
import { headers } from "next/headers";

const PositionDetailsResponsibilities = async () => {
  ...
  return (
    <div className="space-y-2">
      <PositionDetailsResponsibilitiesForm
...
export default PositionDetailsResponsibilities;
