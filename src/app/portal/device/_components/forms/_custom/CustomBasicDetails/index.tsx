...
export default function CustomBasicDetails({
  ...
  const createDeviceGroupSettings = api.deviceGroupSetting.createDeviceGroupSettings.useMutation()
      ...
      <>
        ...
        <div className='grid grid-cols-2 gap-4 border p-4 mt-4 rounded-md pb-12'>
          ...
          <div className=" justify-center">
            <div className=" max-w-[500px] h-[185px] rounded-lg">
